                            ...
                            <MasterTableView AutoGenerateColumns="false" DataSourceID="sqlDS_Venues" Font-Names="Arial"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="false">
                                        <ItemTemplate>
                                        <asp:ImageButton ID="imgb_Edit" runat="server" ToolTip="Edit..." ImageUrl="~/Images/Edit_btn.gif" CausesValidation="false" PostBackUrl='<%# "~/Admin/Venues_Edit.aspx?key="+Eval("VenueKey")+"&returnurl=Venues_List.aspx"+ Request.Url.Query %>'/>
                                        </ItemTemplate>
