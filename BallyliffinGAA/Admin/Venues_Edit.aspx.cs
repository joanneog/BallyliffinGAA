...
{
    public partial class Venues_Edit : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            if (!string.IsNullOrEmpty(Request["key"]))
            {
                ...
                sp_Venues_SignleRecordResult record = db.sp_Venues_SignleRecord(new Guid(Request["key"])).SingleOrDefault();
                txt_VenueDesc.Text = record.VenueDesc;
