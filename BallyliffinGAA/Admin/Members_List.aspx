                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Joined" AllowFiltering="false" SortExpression="DateJoined">
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="Edit" AllowFiltering="false">
                                        <ItemTemplate>
                                        <asp:ImageButton ID="imgb_Edit" runat="server" ToolTip="Edit..." ImageUrl="~/Images/Edit_btn.gif" CausesValidation="false" PostBackUrl='<%# "~/Admin/Members_Edit.aspx?key="+Eval("MemberKey")+"&returnurl=Members_List.aspx" + Request.Url.Query %>'/>
                                        </ItemTemplate>
